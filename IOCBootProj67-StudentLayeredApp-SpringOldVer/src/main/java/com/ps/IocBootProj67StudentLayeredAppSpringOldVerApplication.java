...
public class IocBootProj67StudentLayeredAppSpringOldVerApplication {
	...
	public static void main(String[] args) {
		...
		ctx=SpringApplication.run(IocBootProj67StudentLayeredAppSpringOldVerApplication.class, args);
